        ...
        <div className="flex flex-col gap-2 pt-2">
            <div className="flex flex-row">
                <div className="flex justify-center">
                    <Icons src="#icon-game" alt="Icon Placeholder" className="w-12 h-12 justify-center" />
                </div>
                <p className="ml-3">Large sélection de jeux : Une variété de jeux de société et de jeux vidéo pour tous les goûts.</p>
            </div>
            <div className="flex flex-row">
                <div className="flex justify-center">
                    <Icons src="#icon-community" alt="Icon Placeholder" className="w-12 h-12 justify-center" />
                </div>
                <p className="ml-3">Communauté engagée : Connectez-vous avec des joueurs passionnés et partagez votre amour du jeu.</p>
            </div>
            <div className="flex flex-row">
                <div className="flex justify-center">
                    <Icons src="#icon-friendly" alt="Icon Placeholder" className="w-12 h-12 justify-center" />
                </div>
            ...
            <div className="flex flex-row">
                <div className="flex justify-center">
                    <Icons src="#icon-text" alt="Icon Placeholder" className="w-12 h-12 justify-center" />
                </div>
